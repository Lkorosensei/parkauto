...
public class Commande {
	...
	private List<LigneCMD> ligneCmdListe;
	...
	public Commande(Long id, int qte, String dateCmd, String description, double prix, double prixTotal, Client client,
		...
		this.client = client;
		this.ligneCmdListe = ligneCmdListe;
	}
	...
	public List<LigneCMD> getLigneCmdListe() {
		return ligneCmdListe;
	}

	public void setLigneCmdListe(List<LigneCMD> ligneCmdListe) {
		this.ligneCmdListe = ligneCmdListe;
	}
